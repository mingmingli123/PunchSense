export function createProjectIo(deps) {
  ...
  function exportConfig() {
    ...
    return {
      ...
      pcb_pin_contacts: {
        ...
        extra_layer_count: c.pcbPinExtraLayerCount,
      },
  ...
  function exportProject() {
    ...
    return {
      ...
      controls: {
        ...
        pcbPinExtraLayerCount: c.pcbPinExtraLayerCount,
  ...
  function applyProjectControls(values) {
    ...
    const numericFields = [
      ...
      "epi", "gridLineCount", "pcbPinContactEpi", "pcbPinContactWidth", "pcbPinExtraLayerCount", "frameLoops", "frameSpacing", "materialOverlapWidth", "previewLayer",
