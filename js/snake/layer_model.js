export function createTpuLayerModel(deps) {
  ...
  function generatedLayerCount(c) {
    const pinExtraLayers = c.pcbPinContactsEnabled && c.hasPcbPinContactShapes
      ? Math.max(0, Number(c.pcbPinExtraLayerCount ?? 0))
      : 0;
    return Number(c.baseLayerCount ?? 1) + pinExtraLayers;
  }
