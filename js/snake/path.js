...
import {
  pointsBounds,
} from "./geometry_helpers.js?v=auto-workflow-pin-endpoint-final-v1-20260827";
import {
...
} from "./corridor.js?v=auto-workflow-pin-endpoint-final-v1-20260827";
import {
...
} from "./segment_subtract.js?v=auto-workflow-pin-endpoint-final-v1-20260827";
import {
...
} from "./connections.js?v=auto-workflow-pin-endpoint-final-v1-20260827";
import { buildTpuSnakePath } from "./candidates.js?v=auto-workflow-pin-endpoint-final-v1-20260827";
import { buildGuidedSnakePath } from "./guided_path.js?v=auto-workflow-pin-endpoint-final-v1-20260827";
import {
...
} from "./guided_builder.js?v=auto-workflow-pin-endpoint-final-v1-20260827";
import {
  createGuidedPathHelpers,
} from "./guided_helpers.js?v=auto-workflow-pin-endpoint-final-v1-20260827";
...
function bestSerpentineCandidate(rows, sourceBucket, c, deps) {
  ...
  if (target <= 0) {
    ...
    if (firstBlockedSnakePoint(path, sourceBucket, deps.blockedSnakeBucket, { endpoints }, c)) return null;
    ...
    for (let end = start; end < rows.length; end += 1) {
      ...
      for (const variantRows of [slice, slice.slice().reverse()]) {
        ...
        for (const path of candidatePaths) {
          ...
          if (firstBlockedSnakePoint(path, sourceBucket, deps.blockedSnakeBucket, { endpoints }, c)) continue;
