import {
  ...
  toolStandbyTemp,
  toolTemp,
} from "./js/materials/profiles.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  CONTROL_IDS,
  PRINT_CONSTANTS,
} from "./js/core/constants.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createDomRefs,
} from "./js/app/dom_refs.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createWorkflowController,
} from "./js/app/workflow.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createInitialAppState,
} from "./js/app/state.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createViewport,
} from "./js/app/viewport.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createScrollLockController,
} from "./js/app/scroll_lock.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createUndoController,
} from "./js/app/undo.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createSelectionController,
} from "./js/app/selection.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  startPunchPrintApp,
} from "./js/app/startup.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createShapeStateController,
} from "./js/app/shape_state.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  clamp,
  distance,
  interpolatePoint,
...
} from "./js/snake/path.js?v=auto-workflow-segment-guides-v3-20260823";
import {
...
import {
  ...
  fitSvgGeometryToBed,
  fitSvgPolygonsToBed,
} from "./js/svg_import.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  normalizeProjectData,
} from "./js/project/state.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createProjectIo,
...
import {
  ...
  gcodeFilename,
  projectFilename,
} from "./js/project/file_exports.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  cloneShape,
...
import {
  ...
  hexToRgba,
} from "./js/canvas/draw_helpers.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createSnakeUi,
} from "./js/snake/ui.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createShapeEditing,
...
} from "./js/materials/regions.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  boundedScanValue,
  ...
  uniqueSortedBreaks,
} from "./js/grid_segments.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createMaterialGridModel,
  roundMaybe,
} from "./js/materials/grid.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createMaterialPostprocess,
} from "./js/materials/postprocess.js?v=auto-workflow-segment-guides-v3-20260823";
import {
...
} from "./js/gcode_path_helpers.js?v=auto-workflow-segment-guides-v3-20260823";
import {
...
import {
  createTpuSnakeModel,
} from "./js/snake/model.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createTpuLayerModel,
} from "./js/snake/layer_model.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  bindInteractionEvents,
} from "./js/canvas/interaction_bindings.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createImportHandlers,
} from "./js/project/import_handlers.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createConfigModel,
...
} from "./js/canvas/shape_interactions.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  createCanvasRenderer,
  visibleUnionEdgePaths,
} from "./js/canvas/renderer.js?v=auto-workflow-segment-guides-v3-20260823";
import {
  offsetFramePath,
} from "./js/frame_geometry.js";
import {
  createGcodeGenerator,
} from "./js/gcode_generator.js?v=auto-workflow-segment-guides-v3-20260823";
import {
...
} from "./js/pcb_cutout.js?v=auto-workflow-segment-guides-v3-20260823";
...
function autoPlacePcbAndGuides() {
  ...
  setSvgImportStatus(`自动连接：已生成 ${guideConnections.length} 条 guide，路径为 D2 -> ${touchpoints.length} 个触点 -> D7。`);
  draw();
}
...
function buildAutoWorkflowGuideConnections(c, pcbShape, touchpoints) {
  const d2 = pcbPinEndpointForAutoWorkflow(c, pcbShape, "bottom_3");
  ...
  for (let i = 1; i < nodes.length; i += 1) {
    ...
    const guide = orthogonalGuideBetween(start.point, end.point);
    const connection = createGuidedTpuSnakeConnection(
      guide,
      connections.length,
      c,
      "auto_workflow",
      (point) => autoWorkflowEndpointResolver(point, c, start, end),
    );
    ...
    connection.targetLength = Math.max(Number(c.tpuSnakeTargetLength || 200), polylineLength(guide));
...
const {
  ...
  pushUndoSnapshot,
  draw,
  pcbPinContactRegions: (c, shapes) => pcbPinContactRegions(c, shapes, state.tpuSnake.connections, FIRST_LAYER_MATERIAL),
});
